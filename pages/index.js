...
export default function Home() {
    ...
    <div >
     ...
     <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
        <div class="flex items-center flex-shrink-0 text-white mr-6">
          ...
          <span class="font-semibold text-xl tracking-tight">Open sea</span>
        </div>
     ...
     <div class="grid grid-cols-3 lg:gap-3 justify-items-center">
       ...
       <div class="rounded overflow-hidden shadow-lg max-w-sm">
         ...
         <div class="py-10">
            <div class="rounded overflow-hidden shadow-lg max-w-sm">
                <img src="https://images.unsplash.com/photo-1643772526710-adf60ceaa303?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt=""/>
  <div class="px-6 py-4">
      <div class="font-bold text-xl mb-2">mountain</div>
 ...
 <div class="px-6 py-4">
     ...
     <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Read more</button>
             ...
             <div class="py-10">
               <div class="rounded overflow-hidden shadow-lg max-w-sm">
                   <img src="https://images.unsplash.com/photo-1643771905812-b2fe27c08574?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1172&q=80" alt=""/>
                   <div class="px-6 py-4">
                       <div class="font-bold text-xl mb-2">mountain</div>
                       <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit esse reiciendis culpa doloremque perferendis mollitia repellendus, ab, minus laborum possimus voluptas dolor. Doloribus itaque laboriosam, mollitia et dicta distinctio voluptatibus!</p>
                       <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Read more</button>
